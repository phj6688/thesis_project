...
class BERT:
    def __init__(self,train_path,test_path,trainings_arguments:TrainingArguments, model_name='bert-base-uncased', max_seq_len=20):
    ...
    def prepare_dataset(self, train_path, test_path):
        ...
        train_data = train_df[train_df['text'].apply(lambda x: isinstance(x, str))]
        test_data = test_df[test_df['text'].apply(lambda x: isinstance(x, str))]
        # tokenize the text
