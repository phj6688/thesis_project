...
if __name__ == '__main__':
    for name in dataset_list:
        try:
            ...
            train_path = f'data/original/{name}/train_50.csv'
            ...
            batch_size = 16
            epochs = 20
            cnn = CNN(dims=300, w2v_path=w2v_path, max_seq_len=max_seq_len, batch_size=batch_size, epochs=epochs, chunk_size=100)
